// Обработка массивов с помощью функций Правка 1
{
...
// Области видимости
{
    ...
    let scope = "global";               // Объ­яв­ле­ние гло­баль­ной пе­ре­мен­ной
    function checkscope() {
        let scope = "local";            // Объ­яв­ле­ние ло­каль­ной пе­ре­мен­ной с тем же име­нем
    ...
    function checkscope() {
        ...
        let i;
        function nested() {
            let scope = "nested scope"; // Вло­жен­ная об­ласть ви­ди­мо­сти ло­каль­ных пе­ре­мен­ных
            return scope + x;               // Вер­нет зна­че­ние этой пе­ре­мен­ной scope
        }
        if (true) {
            let i = '1';
        }
    ...
    function test(o) {
        let i = 0;                       // i оп­ре­де­ле­на в те­ле всей функ­ции
        if (typeof o == "object") {
            let j = 0;                   // j оп­ре­де­ле­на вез­де, не толь­ко в бло­ке
            for (let k = 0; k < 10; k++) {  // k оп­ре­де­ле­на вез­де, не толь­ко в цик­ле
    ...
    let scope = "global";
    function f() {
        let scope = "local"; // Ини­циа­ли­зи­ру­ет­ся здесь
...
}
{
    ...
    function checkscope() {
        ...
        function f() {
            ...
            return scope;
        } // Вер­нет зна­че­ние ло­каль­ной пе­ре­мен­ной scope
        return f;
    }
...

{
    ...
    };                   // Объ­ект, к ко­то­ро­му вы­пол­ня­ет­ся при­вяз­ка
